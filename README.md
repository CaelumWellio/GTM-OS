...
The events intelligence sits alongside this in [events/](events/README.md): what the conference programme returned, and a rubric for deciding the next booking.
