...
- "The Headmaster wants this program to provide students with "down-time" - should still be learning but a chance to step away from high pressure study" (Independent secondary, NSW, won)
...
- "I am the best contact for a free trial. It is just such a busy term, but I would love to share some of the resources with my Pastoral Team to see if they can make it work." (Catholic secondary, QLD, won)
...
- "The teaching team spends 3-4 hours per week creating a single 15-minute lesson. This is seen as a significant time sink and potentially unsustainable." (Government secondary, NSW, won)

Source: ~/Documents/GTM Project/outputs/customer_truth/summary.json (stage 3), deals_tagged.jsonl (stage 2), deals_early_text.jsonl (stage 1); method in customer-truth/method.md

### price_budget

- "I have arranged for our budget next year to include the cost of Wellio - from our conversation earlier in the year, my understanding is that it is approx.. $30 per student enrolled." (Catholic secondary, QLD, won)
- "It does not look like we are going to have the funds available to make this work for us in 2026 unfortunately; we are struggling to manage the existing programs and expenses" (Government secondary, VIC, won)
- "The price is a major factor for the Principal. Several options have been presented: $29/student (unlimited), $17.50/student (essentials), and $7/student (insights only)." (Independent secondary, WA, won)
...
- "The feedback from staff has been really positive - 100% of those who have responded to my survey on the demo video are keen to get on board!" (Unknown secondary, won)
...
- "3 x 30mins each week...In year levels (about 20 - 25 in a group)...Staff take students through our Brainwise Program, wellbeing modules eg. e-Safety, respectful relationships." (Independent secondary, QLD, won)
