...
- Response speed (`scripts/growth_os/response_speed.py`) is measured from the same cached company timelines and the same early window as the hook pass, not from a fresh pull: first reply, reply ratio and outbound volume are all counted between `window_start` and `window_end` on `outputs/sdr_history/<company_id>.json`.
...
- 2026-09-17: cycle one (retrospective, full cache); population {'deals': 842, 'won': 365, 'lost': 477, 'with_text': 840, 'tagged': 842, 'errors': 0, 'closed_total': 844, 'excluded_no_text': 2, 'excluded_no_text_won': 1, 'excluded_error': 0, 'excluded_untagged': 0}; base rate 0.4335; codebook 1.0; portal 20058914.
- 2026-09-18: response-speed pass on the cycle-one population; population {'deals': 842, 'won': 365, 'lost': 477, 'replied': 675, 'no_reply': 167}; base rate 0.4335; buckets 0-3 46.9% n=559, 4-14 31.3% n=67, 15+ 16.3% n=49, none 44.3% n=167; no-reply anomaly resolved by campaign (83/167 in Free Preview/Contact Sales, conference or diocese/feeder-school campaigns winning 51.8%, the other 84 winning 36.9%), not by source or dealtype.
